...
object PartitionedTableDescriptor extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.partitionedtable.PartitionedTableDescriptor] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.partitionedtable.PartitionedtableProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.partitionedtable.PartitionedtableProto.scalaDescriptor.messages(4)
