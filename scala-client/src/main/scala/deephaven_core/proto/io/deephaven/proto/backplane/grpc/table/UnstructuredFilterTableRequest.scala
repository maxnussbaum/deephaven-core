...
@SerialVersionUID(0L)
final case class UnstructuredFilterTableRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UnstructuredFilterTableRequest] {
    @transient
    ...
    def clearResultId: UnstructuredFilterTableRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): UnstructuredFilterTableRequest = copy(resultId = Option(__v))
    ...
    def clearSourceId: UnstructuredFilterTableRequest = copy(sourceId = _root_.scala.None)
    def withSourceId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): UnstructuredFilterTableRequest = copy(sourceId = Option(__v))
    def clearFilters = copy(filters = _root_.scala.Seq.empty)
    def addFilters(__vs: _root_.scala.Predef.String *): UnstructuredFilterTableRequest = addAllFilters(__vs)
    def addAllFilters(__vs: Iterable[_root_.scala.Predef.String]): UnstructuredFilterTableRequest = copy(filters = filters ++ __vs)
    def withFilters(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UnstructuredFilterTableRequest = copy(filters = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PRepeated(filters.iterator.map(_root_.scalapb.descriptors.PString(_)).toVector)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest.type = io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.UnstructuredFilterTableRequest])
}

object UnstructuredFilterTableRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest(
        ...
        filters = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scala.Seq[_root_.scala.Predef.String]]).getOrElse(_root_.scala.Seq.empty)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(17)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(17)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest(
    resultId = _root_.scala.None,
    sourceId = _root_.scala.None,
    filters = _root_.scala.Seq.empty
  )
  implicit class UnstructuredFilterTableRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest = _root_.io.deephaven.proto.backplane.grpc.table.UnstructuredFilterTableRequest(
    resultId,
    sourceId,
    filters
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.UnstructuredFilterTableRequest])
}
