...
@SerialVersionUID(0L)
final case class CloseDocumentRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[CloseDocumentRequest] {
    @transient
    ...
    def clearConsoleId: CloseDocumentRequest = copy(consoleId = _root_.scala.None)
    def withConsoleId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): CloseDocumentRequest = copy(consoleId = Option(__v))
    ...
    def clearTextDocument: CloseDocumentRequest = copy(textDocument = _root_.scala.None)
    def withTextDocument(__v: io.deephaven.proto.backplane.script.grpc.console.VersionedTextDocumentIdentifier): CloseDocumentRequest = copy(textDocument = Option(__v))
    ...
    def companion: io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest.type = io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.script.grpc.CloseDocumentRequest])
}

object CloseDocumentRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.script.grpc.console.ConsoleProto.javaDescriptor.getMessageTypes().get(21)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.script.grpc.console.ConsoleProto.scalaDescriptor.messages(21)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest(
    consoleId = _root_.scala.None,
    textDocument = _root_.scala.None
  )
  implicit class CloseDocumentRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest = _root_.io.deephaven.proto.backplane.script.grpc.console.CloseDocumentRequest(
    consoleId,
    textDocument
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.script.grpc.CloseDocumentRequest])
}
