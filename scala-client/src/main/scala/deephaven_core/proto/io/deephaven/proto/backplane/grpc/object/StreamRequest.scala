...
object StreamRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.`object`.StreamRequest] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.`object`.ObjectProto.javaDescriptor.getMessageTypes().get(5)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.`object`.ObjectProto.scalaDescriptor.messages(5)
