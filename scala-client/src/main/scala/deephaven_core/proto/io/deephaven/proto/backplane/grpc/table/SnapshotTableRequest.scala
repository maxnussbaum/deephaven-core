...
@SerialVersionUID(0L)
final case class SnapshotTableRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SnapshotTableRequest] {
    @transient
    ...
    def clearResultId: SnapshotTableRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): SnapshotTableRequest = copy(resultId = Option(__v))
    ...
    def clearSourceId: SnapshotTableRequest = copy(sourceId = _root_.scala.None)
    def withSourceId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): SnapshotTableRequest = copy(sourceId = Option(__v))
    ...
    def companion: io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest.type = io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.SnapshotTableRequest])
}

object SnapshotTableRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(22)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(22)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest(
    resultId = _root_.scala.None,
    sourceId = _root_.scala.None
  )
  implicit class SnapshotTableRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest = _root_.io.deephaven.proto.backplane.grpc.table.SnapshotTableRequest(
    resultId,
    sourceId
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.SnapshotTableRequest])
}
