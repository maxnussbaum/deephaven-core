...
@SerialVersionUID(0L)
final case class FlattenRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[FlattenRequest] {
    @transient
    ...
    def clearResultId: FlattenRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): FlattenRequest = copy(resultId = Option(__v))
    ...
    def clearSourceId: FlattenRequest = copy(sourceId = _root_.scala.None)
    def withSourceId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): FlattenRequest = copy(sourceId = Option(__v))
    ...
    def companion: io.deephaven.proto.backplane.grpc.table.FlattenRequest.type = io.deephaven.proto.backplane.grpc.table.FlattenRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.FlattenRequest])
}

object FlattenRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.FlattenRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.FlattenRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.FlattenRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.FlattenRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(57)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(57)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.FlattenRequest(
    resultId = _root_.scala.None,
    sourceId = _root_.scala.None
  )
  implicit class FlattenRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.FlattenRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.FlattenRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.FlattenRequest = _root_.io.deephaven.proto.backplane.grpc.table.FlattenRequest(
    resultId,
    sourceId
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.FlattenRequest])
}
