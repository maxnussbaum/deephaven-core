...
@SerialVersionUID(0L)
final case class HeadOrTailRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[HeadOrTailRequest] {
    @transient
    ...
    def clearResultId: HeadOrTailRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): HeadOrTailRequest = copy(resultId = Option(__v))
    ...
    def clearSourceId: HeadOrTailRequest = copy(sourceId = _root_.scala.None)
    def withSourceId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): HeadOrTailRequest = copy(sourceId = Option(__v))
    def withNumRows(__v: _root_.scala.Long): HeadOrTailRequest = copy(numRows = __v)
    ...
    def companion: io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest.type = io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.HeadOrTailRequest])
}

object HeadOrTailRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(18)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(18)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest(
    resultId = _root_.scala.None,
    sourceId = _root_.scala.None,
    numRows = 0L
  )
  implicit class HeadOrTailRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest = _root_.io.deephaven.proto.backplane.grpc.table.HeadOrTailRequest(
    resultId,
    sourceId,
    numRows
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.HeadOrTailRequest])
}
