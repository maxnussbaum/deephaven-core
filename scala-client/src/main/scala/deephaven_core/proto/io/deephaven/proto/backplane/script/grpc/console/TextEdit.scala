...
final case class TextEdit(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[TextEdit] {
    @transient
    ...
    def clearRange: TextEdit = copy(range = _root_.scala.None)
    def withRange(__v: io.deephaven.proto.backplane.script.grpc.console.DocumentRange): TextEdit = copy(range = Option(__v))
    def withText(__v: _root_.scala.Predef.String): TextEdit = copy(text = __v)
    ...
    def companion: io.deephaven.proto.backplane.script.grpc.console.TextEdit.type = io.deephaven.proto.backplane.script.grpc.console.TextEdit
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.script.grpc.TextEdit])
}

object TextEdit extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.script.grpc.console.TextEdit] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.script.grpc.console.TextEdit] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.script.grpc.console.TextEdit = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.script.grpc.console.TextEdit] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.script.grpc.console.ConsoleProto.javaDescriptor.getMessageTypes().get(31)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.script.grpc.console.ConsoleProto.scalaDescriptor.messages(31)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.script.grpc.console.TextEdit(
    range = _root_.scala.None,
    text = ""
  )
  implicit class TextEditLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.script.grpc.console.TextEdit]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.script.grpc.console.TextEdit](_l) {
  ...
  def of(
    ...
    text: _root_.scala.Predef.String
  ): _root_.io.deephaven.proto.backplane.script.grpc.console.TextEdit = _root_.io.deephaven.proto.backplane.script.grpc.console.TextEdit(
    range,
    text
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.script.grpc.TextEdit])
}
