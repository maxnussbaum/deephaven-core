...
object BadDataBehavior extends _root_.scalapb.GeneratedEnumCompanion[BadDataBehavior] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = TableProto.javaDescriptor.getEnumTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = TableProto.scalaDescriptor.enums(0)
}