...
@SerialVersionUID(0L)
final case class FilterTableRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[FilterTableRequest] {
    @transient
    ...
    def clearResultId: FilterTableRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): FilterTableRequest = copy(resultId = Option(__v))
    ...
    def clearSourceId: FilterTableRequest = copy(sourceId = _root_.scala.None)
    def withSourceId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): FilterTableRequest = copy(sourceId = Option(__v))
    def clearFilters = copy(filters = _root_.scala.Seq.empty)
    def addFilters(__vs: io.deephaven.proto.backplane.grpc.table.Condition *): FilterTableRequest = addAllFilters(__vs)
    def addAllFilters(__vs: Iterable[io.deephaven.proto.backplane.grpc.table.Condition]): FilterTableRequest = copy(filters = filters ++ __vs)
    def withFilters(__v: _root_.scala.Seq[io.deephaven.proto.backplane.grpc.table.Condition]): FilterTableRequest = copy(filters = __v)
    ...
    def companion: io.deephaven.proto.backplane.grpc.table.FilterTableRequest.type = io.deephaven.proto.backplane.grpc.table.FilterTableRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.FilterTableRequest])
}

object FilterTableRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.FilterTableRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.FilterTableRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.FilterTableRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.FilterTableRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(40)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(40)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.FilterTableRequest(
    resultId = _root_.scala.None,
    sourceId = _root_.scala.None,
    filters = _root_.scala.Seq.empty
  )
  implicit class FilterTableRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.FilterTableRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.FilterTableRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.FilterTableRequest = _root_.io.deephaven.proto.backplane.grpc.table.FilterTableRequest(
    resultId,
    sourceId,
    filters
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.FilterTableRequest])
}
