...
object FetchFileResponse extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.storage.FetchFileResponse] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = StorageProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = StorageProto.scalaDescriptor.messages(4)
