...
/** @param asOfColumn
  ...
  */
@SerialVersionUID(0L)
final case class AjRajTablesRequest(
    ...
    asOfColumn: _root_.scala.Predef.String = "",
    columnsToAdd: _root_.scala.Seq[_root_.scala.Predef.String] = _root_.scala.Seq.empty,
    unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AjRajTablesRequest] {
    @transient
    ...
    def clearResultId: AjRajTablesRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): AjRajTablesRequest = copy(resultId = Option(__v))
    ...
    def clearLeftId: AjRajTablesRequest = copy(leftId = _root_.scala.None)
    def withLeftId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): AjRajTablesRequest = copy(leftId = Option(__v))
    ...
    def clearRightId: AjRajTablesRequest = copy(rightId = _root_.scala.None)
    def withRightId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): AjRajTablesRequest = copy(rightId = Option(__v))
    def clearExactMatchColumns = copy(exactMatchColumns = _root_.scala.Seq.empty)
    def addExactMatchColumns(__vs: _root_.scala.Predef.String *): AjRajTablesRequest = addAllExactMatchColumns(__vs)
    def addAllExactMatchColumns(__vs: Iterable[_root_.scala.Predef.String]): AjRajTablesRequest = copy(exactMatchColumns = exactMatchColumns ++ __vs)
    def withExactMatchColumns(__v: _root_.scala.Seq[_root_.scala.Predef.String]): AjRajTablesRequest = copy(exactMatchColumns = __v)
    def withAsOfColumn(__v: _root_.scala.Predef.String): AjRajTablesRequest = copy(asOfColumn = __v)
    def clearColumnsToAdd = copy(columnsToAdd = _root_.scala.Seq.empty)
    def addColumnsToAdd(__vs: _root_.scala.Predef.String *): AjRajTablesRequest = addAllColumnsToAdd(__vs)
    def addAllColumnsToAdd(__vs: Iterable[_root_.scala.Predef.String]): AjRajTablesRequest = copy(columnsToAdd = columnsToAdd ++ __vs)
    def withColumnsToAdd(__v: _root_.scala.Seq[_root_.scala.Predef.String]): AjRajTablesRequest = copy(columnsToAdd = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 5 => _root_.scalapb.descriptors.PString(asOfColumn)
        case 6 => _root_.scalapb.descriptors.PRepeated(columnsToAdd.iterator.map(_root_.scalapb.descriptors.PString(_)).toVector)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest.type = io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.AjRajTablesRequest])
}

object AjRajTablesRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest = {
    ...
    var __asOfColumn: _root_.scala.Predef.String = ""
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 42 =>
          __asOfColumn = _input__.readStringRequireUtf8()
        case 50 =>
    ...
    io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest(
        ...
        asOfColumn = __asOfColumn,
        columnsToAdd = __columnsToAdd.result(),
        unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest(
        ...
        asOfColumn = __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        columnsToAdd = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Seq[_root_.scala.Predef.String]]).getOrElse(_root_.scala.Seq.empty)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(29)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(29)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest(
  ...
  implicit class AjRajTablesRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest](_l) {
    ...
    def asOfColumn: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.asOfColumn)((c_, f_) => c_.copy(asOfColumn = f_))
  ...
  final val AS_OF_COLUMN_FIELD_NUMBER = 5
  final val COLUMNS_TO_ADD_FIELD_NUMBER = 6
  def of(
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest = _root_.io.deephaven.proto.backplane.grpc.table.AjRajTablesRequest(
    resultId,
    leftId,
    rightId,
    exactMatchColumns,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.AjRajTablesRequest])
}
