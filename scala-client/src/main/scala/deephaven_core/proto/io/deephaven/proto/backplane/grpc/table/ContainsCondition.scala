...
@SerialVersionUID(0L)
final case class ContainsCondition(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ContainsCondition] {
    @transient
    ...
    def clearReference: ContainsCondition = copy(reference = _root_.scala.None)
    def withReference(__v: io.deephaven.proto.backplane.grpc.table.Reference): ContainsCondition = copy(reference = Option(__v))
    def withSearchString(__v: _root_.scala.Predef.String): ContainsCondition = copy(searchString = __v)
    def withCaseSensitivity(__v: io.deephaven.proto.backplane.grpc.table.CaseSensitivity): ContainsCondition = copy(caseSensitivity = __v)
    def withMatchType(__v: io.deephaven.proto.backplane.grpc.table.MatchType): ContainsCondition = copy(matchType = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => _root_.scalapb.descriptors.PString(searchString)
    ...
    def companion: io.deephaven.proto.backplane.grpc.table.ContainsCondition.type = io.deephaven.proto.backplane.grpc.table.ContainsCondition
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.ContainsCondition])
}

object ContainsCondition extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.ContainsCondition] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.ContainsCondition] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.ContainsCondition = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.ContainsCondition] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      io.deephaven.proto.backplane.grpc.table.ContainsCondition(
        ...
        searchString = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(55)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(55)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.ContainsCondition(
  ...
  implicit class ContainsConditionLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.ContainsCondition]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.ContainsCondition](_l) {
  ...
  final val SEARCH_STRING_FIELD_NUMBER = 2
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.ContainsCondition = _root_.io.deephaven.proto.backplane.grpc.table.ContainsCondition(
    reference,
    searchString,
    caseSensitivity,
    matchType
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.ContainsCondition])
}
