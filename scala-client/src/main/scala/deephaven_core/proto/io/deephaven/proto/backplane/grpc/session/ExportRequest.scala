...
final case class ExportRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ExportRequest] {
    @transient
    ...
    def clearSourceId: ExportRequest = copy(sourceId = _root_.scala.None)
    def withSourceId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): ExportRequest = copy(sourceId = Option(__v))
    ...
    def clearResultId: ExportRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): ExportRequest = copy(resultId = Option(__v))
    ...
    def companion: io.deephaven.proto.backplane.grpc.session.ExportRequest.type = io.deephaven.proto.backplane.grpc.session.ExportRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.ExportRequest])
}

object ExportRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.session.ExportRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.session.ExportRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.session.ExportRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.session.ExportRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.session.SessionProto.javaDescriptor.getMessageTypes().get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.session.SessionProto.scalaDescriptor.messages(6)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.session.ExportRequest(
    sourceId = _root_.scala.None,
    resultId = _root_.scala.None
  )
  implicit class ExportRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.session.ExportRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.session.ExportRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.session.ExportRequest = _root_.io.deephaven.proto.backplane.grpc.session.ExportRequest(
    sourceId,
    resultId
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.ExportRequest])
}
