...
@SerialVersionUID(0L)
final case class LeftJoinTablesRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[LeftJoinTablesRequest] {
    @transient
    ...
    def clearResultId: LeftJoinTablesRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): LeftJoinTablesRequest = copy(resultId = Option(__v))
    ...
    def clearLeftId: LeftJoinTablesRequest = copy(leftId = _root_.scala.None)
    def withLeftId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): LeftJoinTablesRequest = copy(leftId = Option(__v))
    ...
    def clearRightId: LeftJoinTablesRequest = copy(rightId = _root_.scala.None)
    def withRightId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): LeftJoinTablesRequest = copy(rightId = Option(__v))
    def clearColumnsToMatch = copy(columnsToMatch = _root_.scala.Seq.empty)
    def addColumnsToMatch(__vs: _root_.scala.Predef.String *): LeftJoinTablesRequest = addAllColumnsToMatch(__vs)
    def addAllColumnsToMatch(__vs: Iterable[_root_.scala.Predef.String]): LeftJoinTablesRequest = copy(columnsToMatch = columnsToMatch ++ __vs)
    def withColumnsToMatch(__v: _root_.scala.Seq[_root_.scala.Predef.String]): LeftJoinTablesRequest = copy(columnsToMatch = __v)
    def clearColumnsToAdd = copy(columnsToAdd = _root_.scala.Seq.empty)
    def addColumnsToAdd(__vs: _root_.scala.Predef.String *): LeftJoinTablesRequest = addAllColumnsToAdd(__vs)
    def addAllColumnsToAdd(__vs: Iterable[_root_.scala.Predef.String]): LeftJoinTablesRequest = copy(columnsToAdd = columnsToAdd ++ __vs)
    def withColumnsToAdd(__v: _root_.scala.Seq[_root_.scala.Predef.String]): LeftJoinTablesRequest = copy(columnsToAdd = __v)
    ...
    def companion: io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest.type = io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.LeftJoinTablesRequest])
}

object LeftJoinTablesRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(27)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(27)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest(
  ...
  implicit class LeftJoinTablesRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest = _root_.io.deephaven.proto.backplane.grpc.table.LeftJoinTablesRequest(
    resultId,
    leftId,
    rightId,
    columnsToMatch,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.LeftJoinTablesRequest])
}
