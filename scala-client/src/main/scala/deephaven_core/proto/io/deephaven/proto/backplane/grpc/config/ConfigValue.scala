...
object ConfigValue extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.config.ConfigValue] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.config.ConfigProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.config.ConfigProto.scalaDescriptor.messages(4)
