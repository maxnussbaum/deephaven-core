...
@SerialVersionUID(0L)
final case class ExactJoinTablesRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ExactJoinTablesRequest] {
    @transient
    ...
    def clearResultId: ExactJoinTablesRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): ExactJoinTablesRequest = copy(resultId = Option(__v))
    ...
    def clearLeftId: ExactJoinTablesRequest = copy(leftId = _root_.scala.None)
    def withLeftId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): ExactJoinTablesRequest = copy(leftId = Option(__v))
    ...
    def clearRightId: ExactJoinTablesRequest = copy(rightId = _root_.scala.None)
    def withRightId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): ExactJoinTablesRequest = copy(rightId = Option(__v))
    def clearColumnsToMatch = copy(columnsToMatch = _root_.scala.Seq.empty)
    def addColumnsToMatch(__vs: _root_.scala.Predef.String *): ExactJoinTablesRequest = addAllColumnsToMatch(__vs)
    def addAllColumnsToMatch(__vs: Iterable[_root_.scala.Predef.String]): ExactJoinTablesRequest = copy(columnsToMatch = columnsToMatch ++ __vs)
    def withColumnsToMatch(__v: _root_.scala.Seq[_root_.scala.Predef.String]): ExactJoinTablesRequest = copy(columnsToMatch = __v)
    def clearColumnsToAdd = copy(columnsToAdd = _root_.scala.Seq.empty)
    def addColumnsToAdd(__vs: _root_.scala.Predef.String *): ExactJoinTablesRequest = addAllColumnsToAdd(__vs)
    def addAllColumnsToAdd(__vs: Iterable[_root_.scala.Predef.String]): ExactJoinTablesRequest = copy(columnsToAdd = columnsToAdd ++ __vs)
    def withColumnsToAdd(__v: _root_.scala.Seq[_root_.scala.Predef.String]): ExactJoinTablesRequest = copy(columnsToAdd = __v)
    ...
    def companion: io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest.type = io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.ExactJoinTablesRequest])
}

object ExactJoinTablesRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(26)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(26)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest(
  ...
  implicit class ExactJoinTablesRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest = _root_.io.deephaven.proto.backplane.grpc.table.ExactJoinTablesRequest(
    resultId,
    leftId,
    rightId,
    columnsToMatch,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.ExactJoinTablesRequest])
}
