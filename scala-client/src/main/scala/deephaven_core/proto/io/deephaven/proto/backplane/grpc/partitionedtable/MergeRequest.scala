...
final case class MergeRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[MergeRequest] {
    @transient
    ...
    def clearPartitionedTable: MergeRequest = copy(partitionedTable = _root_.scala.None)
    def withPartitionedTable(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): MergeRequest = copy(partitionedTable = Option(__v))
    ...
    def clearResultId: MergeRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): MergeRequest = copy(resultId = Option(__v))
    ...
    def companion: io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest.type = io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.MergeRequest])
}

object MergeRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.partitionedtable.PartitionedtableProto.javaDescriptor.getMessageTypes().get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.partitionedtable.PartitionedtableProto.scalaDescriptor.messages(2)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest(
    partitionedTable = _root_.scala.None,
    resultId = _root_.scala.None
  )
  implicit class MergeRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest = _root_.io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest(
    partitionedTable,
    resultId
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.MergeRequest])
}
