...
object MergeRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.partitionedtable.MergeRequest] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = PartitionedtableProto.javaDescriptor.getMessageTypes().get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = PartitionedtableProto.scalaDescriptor.messages(2)
