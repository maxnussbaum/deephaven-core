...
object ExportNotification extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.session.ExportNotification] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.session.SessionProto.javaDescriptor.getMessageTypes().get(11)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.session.SessionProto.scalaDescriptor.messages(11)
