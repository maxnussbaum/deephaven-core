...
@SerialVersionUID(0L)
final case class SortTableRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SortTableRequest] {
    @transient
    ...
    def clearResultId: SortTableRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): SortTableRequest = copy(resultId = Option(__v))
    ...
    def clearSourceId: SortTableRequest = copy(sourceId = _root_.scala.None)
    def withSourceId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): SortTableRequest = copy(sourceId = Option(__v))
    def clearSorts = copy(sorts = _root_.scala.Seq.empty)
    def addSorts(__vs: io.deephaven.proto.backplane.grpc.table.SortDescriptor *): SortTableRequest = addAllSorts(__vs)
    def addAllSorts(__vs: Iterable[io.deephaven.proto.backplane.grpc.table.SortDescriptor]): SortTableRequest = copy(sorts = sorts ++ __vs)
    def withSorts(__v: _root_.scala.Seq[io.deephaven.proto.backplane.grpc.table.SortDescriptor]): SortTableRequest = copy(sorts = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PRepeated(sorts.iterator.map(_.toPMessage).toVector)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: io.deephaven.proto.backplane.grpc.table.SortTableRequest.type = io.deephaven.proto.backplane.grpc.table.SortTableRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.SortTableRequest])
}

object SortTableRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.SortTableRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.SortTableRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.SortTableRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.SortTableRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      io.deephaven.proto.backplane.grpc.table.SortTableRequest(
        ...
        sorts = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scala.Seq[io.deephaven.proto.backplane.grpc.table.SortDescriptor]]).getOrElse(_root_.scala.Seq.empty)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(39)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(39)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      ...
      case 3 => __out = io.deephaven.proto.backplane.grpc.table.SortDescriptor
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.SortTableRequest(
    resultId = _root_.scala.None,
    sourceId = _root_.scala.None,
    sorts = _root_.scala.Seq.empty
  )
  implicit class SortTableRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.SortTableRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.SortTableRequest](_l) {
  ...
  final val SORTS_FIELD_NUMBER = 3
  def of(
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.SortTableRequest = _root_.io.deephaven.proto.backplane.grpc.table.SortTableRequest(
    resultId,
    sourceId,
    sorts
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.SortTableRequest])
}
