...
object ClientData extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.`object`.ClientData] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ObjectProto.javaDescriptor.getMessageTypes().get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ObjectProto.scalaDescriptor.messages(3)
