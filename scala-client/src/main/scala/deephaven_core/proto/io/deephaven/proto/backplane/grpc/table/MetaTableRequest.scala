...
@SerialVersionUID(0L)
final case class MetaTableRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[MetaTableRequest] {
    @transient
    ...
    def clearResultId: MetaTableRequest = copy(resultId = _root_.scala.None)
    def withResultId(__v: io.deephaven.proto.backplane.grpc.ticket.Ticket): MetaTableRequest = copy(resultId = Option(__v))
    ...
    def clearSourceId: MetaTableRequest = copy(sourceId = _root_.scala.None)
    def withSourceId(__v: io.deephaven.proto.backplane.grpc.table.TableReference): MetaTableRequest = copy(sourceId = Option(__v))
    ...
    def companion: io.deephaven.proto.backplane.grpc.table.MetaTableRequest.type = io.deephaven.proto.backplane.grpc.table.MetaTableRequest
    // @@protoc_insertion_point(GeneratedMessage[io.deephaven.proto.backplane.grpc.MetaTableRequest])
}

object MetaTableRequest extends scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.MetaTableRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.table.MetaTableRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.deephaven.proto.backplane.grpc.table.MetaTableRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.deephaven.proto.backplane.grpc.table.MetaTableRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.javaDescriptor.getMessageTypes().get(58)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = io.deephaven.proto.backplane.grpc.table.TableProto.scalaDescriptor.messages(58)
  ...
  lazy val defaultInstance = io.deephaven.proto.backplane.grpc.table.MetaTableRequest(
    resultId = _root_.scala.None,
    sourceId = _root_.scala.None
  )
  implicit class MetaTableRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.deephaven.proto.backplane.grpc.table.MetaTableRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.deephaven.proto.backplane.grpc.table.MetaTableRequest](_l) {
  ...
  ): _root_.io.deephaven.proto.backplane.grpc.table.MetaTableRequest = _root_.io.deephaven.proto.backplane.grpc.table.MetaTableRequest(
    resultId,
    sourceId
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.deephaven.proto.backplane.grpc.MetaTableRequest])
}
